...
| --- | --- | --- |
| **AdGenie** | AI advertisement platform · FYP · shown at Innovative Pakistan 2026 | React, Node.js, FastAPI, MongoDB, PyTorch |
| **SoulPlus AI** | Production AI assistant with RAG and multi-step agents | LangGraph, LangChain, FastAPI, Supabase, pgvector |
| **Automated Essay Scoring** | NLP research: BERT for scoring, GPT for feedback | BERT, GPT, PyTorch, Hugging Face |
| **TixTrader** | Full-stack ticket resale marketplace | React, Node.js, Express, MongoDB, JWT |
| **NearBuy** | Location-based local marketplace | MERN, Tailwind |
...
<div align="center">
  ...
  **Available for hire** · Remote · Onsite · Freelance · Collaboration

  <a href="https://aqeel-abbas-khan-portfolio.vercel.app">Portfolio</a>
  ·
  <a href="mailto:aqeelabbaskhan41@gmail.com">aqeelabbaskhan41@gmail.com</a>
  ·
  <a href="https://linkedin.com/in/aqeelabbaskhan">LinkedIn</a>
